...
public class Main {
    public static void main(String[] args) {
        ...
        ColorPoint c1 = new ColorPoint(new Color(255, 0, 0), width/2, height);
        ColorPoint c2 = new ColorPoint(new Color(0, 255, 0), 0, 0);
        ColorPoint c3 = new ColorPoint(new Color(0, 0, 255), width, 0);
